           		...
           		<div class="banner_inner d-flex align-items-center">
					<div class="banner_content">
						<div class="media">
							...
							<!--textbox-->
                            <form name="frmMain" action="q_del-appcheckbox.php" method="post" OnSubmit="return onDelete();">
<div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
<h2 align="center">ข้อมูลการนัดหมาย<br><hr><button type="button" class="btn btn-success" id="sidebarCollapse" >
    <a href="a_add-app.php" style="color:#FFF;"><i class="fas fa-pencil-alt"></i>&nbsp;<span>เพิ่มข้อมูลการนัดหมาย</span></a>
</button>&nbsp;
<input type="submit" name="btnDelete" value="ลบข้อมูลการนัดหมาย" class="btn btn-danger"></h3><br>
  <div class="container">
    <div class="row">
      <table class="table table-striped table-responsive{-sm|-md|-lg|-xl}">
         <thead>
           <th></th>
           <th> <div align="left">การนัดหมาย</div></th>
          <th> <div align="left">วันที่</div></th>
          <th> <div align="left">เวลา</div></th>
         <th> <div align="left">แพทย์ผู้รับผิดชอบ</div></th>
         <th> <div align="left">ชื่อสัตว์เลี้ยง</div></th>
      </thead>
      <tbody>
        <?php
        while($rs_app=mysqli_fetch_array($query_select_app,MYSQLI_ASSOC))
        {
        ?>
           <tr>
             <td><input type="checkbox" name="chkDel[]" value="<?php echo $rs_app["app_id"];?>"></td>
             <td align="left"><a href="a_show-listapp.php?pet_id=<?php echo $rs_app["app_id"];?>"><?php echo $rs_app["app_symptom"];?></a></td>
              <td align="left"><?php echo $rs_app["app_date"];?></td>
            <td align="left"><?php echo $rs_app["app_time"];?></td>
            <td align="left"><?php echo $rs_app["vet_name"];?></td>
            <td align="left"><?php echo $rs_app["pet_name"];?></td>
            </tr>
            </tbody>
            <?php } ?>
            </tbody>
  ...
  <div class="container">
    ...
    <nav aria-label="Page navigation example">
      <ul class="pagination">
        <li class="page-item">
          <a class="page-link" href="a_show-app.php?page=1" aria-label="Previous">
            <span aria-hidden="true">&laquo;</span>
            <span class="sr-only">Previous</span>
          </a>
        </li>
        <?php for($i=1;$i<=$total_page;$i++){ ?>
        <li class="page-item"><a class="page-link" href="a_show-app.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
        <?php } ?>
          <a class="page-link" href="a_show-app.php?page=<?php echo $total_page;?>" aria-label="Next">
