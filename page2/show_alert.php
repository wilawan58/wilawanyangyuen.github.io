...
<h2 align="center">รายการแจ้งเตือน<br><hr><button type="button" class="btn btn-success" id="sidebarCollapse" >
...
<input type="submit" name="btnDelete" value="ลบข้อมูลการนัดหมาย" class="btn btn-danger"></h3><br>
    ...
    <div class="row">
      <table class="table table-striped table-responsive{-sm|-md|-lg|-xl}">
         <thead>
          ...
          <th> <div align="left">หมายเหตุ</div></th>
      </thead>
      <tbody>
        <?php
        ...
        ?>
           <tr>
             ...
             <td align="left"><a href="a_show-listalert.php?pet_id=<?php echo $rs_app["app_id"];?>"><?php echo $rs_app["app_symptom"];?></a></td>
              <td align="left"><?php echo $rs_app["alert_note"];?></td>
            </tr>
            </tbody>
            <?php } ?>
            </tbody>
  ...
  <div class="container">
    ...
    <nav aria-label="Page navigation example">
      <ul class="pagination">
        <li class="page-item">
          <a class="page-link" href="a_show-alert.php?page=1" aria-label="Previous">
            <span aria-hidden="true">&laquo;</span>
            <span class="sr-only">Previous</span>
          </a>
        </li>
        <?php for($i=1;$i<=$total_page;$i++){ ?>
        <li class="page-item"><a class="page-link" href="a_show-alert.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
        <?php } ?>
          <a class="page-link" href="a_show-alert.php?page=<?php echo $total_page;?>" aria-label="Next">
