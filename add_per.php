           		...
           		<div class="banner_inner d-flex align-items-center">
					<div class="banner_content">
						<div class="media">
							...
							<!--textbox-->
							<form action="q_save-per.php" name="q_save-per" method="post" enctype="multipart/form-data">
<div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
<h2 align="center">เพิ่มข้อมูลเจ้าของ</h3><hr><br>
  <div class="container">
    <div class="row">
<div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
<label>ชื่อ-นามสกุล</label>
<input type="text" name="per_name" class="form-control" placeholder="กรุณากรอกข้อมูล"/><br>
<label>ที่อยู่</label>
<textarea class="form-control" name="per_add" style="height:200px;"></textarea><br>
<label>เบอร์โทรติดต่อ</label>
<input type="text" name="per_tel" class="form-control" placeholder="กรุณากรอกข้อมูล"/><br>
<label>รูปภาพเจ้าของ</label>
<input type="file" name="per_img" class="form-control" placeholder="กรุณากรอกข้อมูล"/>
</div>
</div>
</div>
</div><br><br>
...
<input type="submit" class="from-control btn btn-success" name="a_save-per" value="บันทึกข้อมูล" style="width:100%"/>
</div>
<div class="col-6 col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6">
<input type="reset" class="from-control btn btn-danger" name="a_reset-per" value="เคลียร์ข้อมูล" style="width:100%"/>
</div>
</div>
</div>
</div><br>
